...
class DeltaG(schema_package.DeltaG):
    add_mapping_annotation(schema_package.DeltaG.value, GIPAW_OUT_KEY, '.value')
    add_mapping_annotation(
...
class DeltaGParatec(schema_package.DeltaGParatec):
    add_mapping_annotation(schema_package.DeltaGParatec.value, GIPAW_OUT_KEY, '.value')
    add_mapping_annotation(
        schema_package.DeltaGParatec.value, GIPAW_XML_KEY, ('get_delta_g', ['.@'])
    )
...
class Outputs(schema_package.Outputs):
    ...
    add_mapping_annotation(schema_package.Outputs.delta_g, GIPAW_XML_KEY, '.delta_g')
