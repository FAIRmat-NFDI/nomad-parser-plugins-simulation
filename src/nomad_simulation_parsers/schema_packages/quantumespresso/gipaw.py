...
class Outputs(schema_package.Outputs):
    ...
    add_mapping_annotations(schema_package.Outputs.magnetic_shieldings, GIPAW_OUT_KEY, '.magnetic_shieldings')
    add_mapping_annotations(schema_package.Outputs.magnetic_shieldings, GIPAW_XML_KEY, '.magnetic_shieldings')
    add_mapping_annotations(schema_package.Outputs.magnetic_susceptibilities, GIPAW_OUT_KEY, '.magnetic_susceptibilities')

add_mapping_annotations(general.Simulation.m_def, GIPAW_OUT_KEY, '@')
add_mapping_annotations(general.Simulation.m_def, GIPAW_XML_KEY, '@')
