...
add_mapping_annotations(
    ...
    (model_method.XCFunctional.components, INPUT_XML_KEY, 
...
add_mapping_annotations(
    ...
    BANDSTRUCTURE_XML_KEY, r'bandstructure.vertex[*]."@label"'),
...
add_mapping_annotations(
    ...
    (outputs.Outputs.electronic_band_structures, 
     BANDSTRUCTURE_XML_KEY,('get_bandstructures', ['.@'])),
...
add_mapping_annotations(
    ...
    (outputs.ElectronicDensityOfStates.projected_dos,
     DOS_XML_KEY, 'dos.partialdos.diagram'),
)
