...
class FHIAimsParser:
    ...
    def parse(
        ...
        **kwargs,
        ...
        archive_data_handler.annotation_key = kwargs.get('annotation_key', 'text')
        ...
        if gw_archive is not None:
            ...
            parser.parse(mainfile, gw_archive, logger, annotation_key='text_gw')
            ...
            parser.parse(
                ...
                gw_workflow_archive,
                logger,
                annotation_key='text_gw_workflow',
            )
