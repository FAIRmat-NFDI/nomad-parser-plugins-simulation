...
from nomad_simulation_parsers.schema_packages import turbomole

from .text_parser import TurbomoleOutReader
...
class OutParser(MappingTextParser):
    """
    Couples TurbomoleOutReader with convenience getters used in the mapping rules.
    """

    def __init__(self) -> None:
        super().__init__(text_parser=TurbomoleOutReader())
...
class TurbomoleParser(MatchingParser):
    def parse(
        self,
        mainfile: str,
